...
const rwanda: Country = {
  ...
  description: `Rwanda, the Land of a Thousand Hills, is known for its breathtaking scenery, mountain gorillas, and remarkable recovery from its past. It is a leader in conservation and eco-tourism.`,
