...
const sainthelena: Country = {
  ...
  description: `Saint Helena is a remote volcanic island famous as the place of Napoleon's exile. It offers dramatic landscapes, unique wildlife, and a tranquil atmosphere.`,
  welcomeMessage: `Welcome to Saint Helena! Hike Diana's Peak, visit Napoleon's residence, and enjoy the island's rich maritime history. Experience the peace and natural beauty of this far-flung destination.`,
  ...
  info: {
    climate: 'Subtropical, mild and marine',
    language: 'English',
